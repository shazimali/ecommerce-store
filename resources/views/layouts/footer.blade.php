    ...
    <div class="bg-secondary py-10 border-b-2 border-white">
        <div class="grid lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-2 xs:grid-cols-1  gap-10 px-8">
            <div>
                ...
                <a class="block" href="">
                    <h1 class="text-2xl font-semibold text-center my-2"><span class="text-primary dark:text-black">Every
                            Day</span><span class="text-black dark:text-primary ml-1"></span>{{ website()->title }}</h1>
                </a>
