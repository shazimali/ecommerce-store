...
<tr style="color: #000000; font-size: 16px; font-weight: bold; font-family: Arial, sans-serif;">
<td colspan="2" valign="middle">Product review information</td>
</tr>
{{-- <tr style="color: #000000; font-size: 16px; font-family: Arial, sans-serif;">
    <td style="text-align: start;"><b>ORDER #ED{{ $email_data->order->order_id }}</b></td>
</tr> --}}
<tr style="color: #000000; font-size: 16px; font-family: Arial, sans-serif;">
    <td colspan="2" style="text-align: start;"> <span style="font-size: 20px">Name: </span>{{ $email_data->user->name }}  </td>
</tr>
<tr style="color: #000000; font-size: 16px; font-family: Arial, sans-serif;">
    <td colspan="2" style="text-align: start;"> <span style="font-size: 20px">Product Name: </span>{{ $email_data->product->title }}  </td>
</tr>
<tr style="color: #000000; font-size: 16px; font-family: Arial, sans-serif;">
    <td colspan="2" style="text-align: start;"> <span style="font-size: 20px">Product Review: </span>{{ $email_data->review }}  </td>
</tr>
<tr style="color: #000000; font-size: 16px; font-family: Arial, sans-serif;">
    <td colspan="2" style="text-align: start;"> <span style="font-size: 20px">Product Rating: </span> {{ $email_data->rating }} / 5 </td>
</tr>
<tr>
    <td></td>
</tr>
...
<tr>
    <td>
        <a href="http://localhost:5174/product-review" target="_blank" style="color: #ffffff; background-color:#D19C97; padding: 10px 20px; font-weight: bold;  font-size: 18px; font-family: Arial, sans-serif; text-decoration: none;">Active</a>
    </td>
</tr>
<tr>
    <td></td>
