    ...
    <div class="xs:hidden lg:block md:block">
            ...
            @foreach ($colors as $color)
                <li class="py-2">
                    <input class=" hover:bg-primary checked:bg-primary 
                                    ...
                                    focus:ring-primary border-gray-500" 
                                    type="radio"
                                    wire:click="updateFilter('color','{{ $color->color_name }}')"
                                    id="{{ $cat->title }}"
                                    name="color"
                                    type="radio"
                                    {{ $sub_cat->title ? 'checked' : '' }}
                                    value="{{ $sub_cat->title }}"
                                    >
                    <label class="text-gray-500 text-sm pl-2 font-semibold">{{ $color->color_name }}</label>
                </li>
            @endforeach
        </ul>
        ...
        <div class="py-3 pr-5">
            ...
            <div class="flex justify-between py-2">
                <span><b>{{ getLocation()->currency }}</b>0</span>
                <span><b>{{ getLocation()->currency }}</b>10000</span>
            </div>
        </div>
    </div>
    <div>
