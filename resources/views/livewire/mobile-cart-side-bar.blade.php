<div class="drawer drawer-end">
    <input id="mobile-cart-side-bar" type="checkbox" class="drawer-toggle" />
    <div class="drawer-content mt-3 cursor-pointer">
        <label for="mobile-cart-side-bar"
    ...
    <div class="drawer-side">
        <label for="mobile-cart-side-bar" aria-label="close sidebar" class="drawer-overlay"></label>
