<div class="flex justify-center text-black dark:text-white dark:bg-black">
    <div class="w-full max-w-xs">
        <h3 class="text-4xl font-semibold py-2 text-center">Reset Password</h3>
      ...
      <form wire:submit="submit">
        <div class="mb-4">
         ...
         <div class="mb-4">
          ...
          ]) id="password_confirmation" type="password" wire:model="password_confirmation" placeholder="Confirm Password">
        ...
        <div class="flex items-center justify-between">
            ...
            <svg wire:loading wire:target="submit" aria-hidden="true" role="status" class="inline mr-1 w-6 h-6 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="pl-5">Reset Password</span>
            </button>
        </div>
      </form>
    </div>
