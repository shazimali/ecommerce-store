<div class="grid lg:grid-cols-[25%_75%] md:grid-cols-[25%_75%] xs:grid-col-1 py-10 px-8 text-black">
    <div class="xs:hidden lg:block md:block">
        ...
        <h3 class="text-2xl font-semibold dark:text-white">Filter by category</h3>
        ...
        <ul>
            <li>
                ...
                <label class=" text-sm pl-2 font-semibold dark:text-white">All</label>
            </li>
            @foreach ($categories as $cat)
                <li class="py-2" x-data="{children: false}">
                    ...
                    <label class="text-sm pl-2 font-semibold dark:text-white">{{ $cat->title }}</label>
                        ...
                        <ul class="ml-5" x-show="children">
                            ...
                            <li>
                               ...
                               focus:ring-primary border-gray-500 dark:text-white" 
                                ...
                                value="{{ $sub_cat->slug }}">
                                <label class=" text-sm pl-2 font-semibold">{{ $sub_cat->title }}</label>
                            </li>
                            @endforeach
                        </ul>
                    @endif
        ...
        <h3 class="text-2xl font-semibold dark:text-white">Filter by colors</h3>
        <ul>
            @foreach ($colors as $clr)
                <li class="py-2">
                    <input class=" hover:bg-primary checked:bg-primary 
                                    ...
                                    >
                    <label class="text-sm pl-2 font-semibold dark:text-white">{{ $clr->color_name }}</label>
                </li>
            @endforeach
        </ul>
        ...
        <ul>
            <li class="flex py-2 cursor-pointer" wire:click="updateFilter('rating',1)">
                ...
                @for ($i = 0; $i < 4;  $i++)   
                    ...
                    stroke="currentColor" class="w-6 h-6 cursor-pointer dark:text-white text-blue-gray-500">
            ...
            <li class="flex py-2 cursor-pointer" wire:click="updateFilter('rating',3)">
                ...
                @for ($i = 0; $i < 2;  $i++)   
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-6 h-6 cursor-pointer text-blue-gray-500 dark:text-white">
                    <path stroke-linecap="round" stroke-linejoin="round"
                    d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z">
                    </path>
                    </svg>
        ...
        <h3 class="text-2xl font-semibold dark:text-white">Filter by price</h3>
        <div class="py-3 pr-5">
